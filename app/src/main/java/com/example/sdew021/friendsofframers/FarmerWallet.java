...
public class FarmerWallet extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_farmer_wallet);
        ...
        mDatabase.child("balance").addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                if(Integer.parseInt(amount) < Integer.parseInt(amt) ){
                    Toast.makeText(FarmerWallet.this,"Insufficient Balance",Toast.LENGTH_SHORT).show();
                }
                else{
                    mDatabase.child("balance").setValue(Integer.toString(Integer.parseInt(amount)-Integer.parseInt(amt)));
                    Toast.makeText(FarmerWallet.this,"Transaction Complete",Toast.LENGTH_SHORT).show();
    ...
    public void sendTransactionMessage(String bal){
        SmsManager sms = SmsManager.getDefault();
        sms.sendTextMessage(contact,null,"Rupees "+bal+" has been credited to your account",null,null);
