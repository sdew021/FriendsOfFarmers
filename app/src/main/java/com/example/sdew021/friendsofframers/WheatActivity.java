        ...
        button1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (editText1.getText().toString().isEmpty()) {
                    Toast.makeText(WheatActivity.this, "Enter Price:" + editText1.getText().toString(), Toast.LENGTH_SHORT).show();
                    flag = 0;
                } else {
...
//                    price = Integer.parseInt(editText1.getText().toString())+price;
                    ...
                    Toast.makeText(WheatActivity.this, "Price Updated Success", Toast.LENGTH_SHORT).show();
                }
        ...
        button2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (editText2.getText().toString().isEmpty()) {
                    Toast.makeText(WheatActivity.this, "Enter Quantity:" + editText2.getText().toString(), Toast.LENGTH_SHORT).show();
                    flag = 0;
                } else {
                    mDatabase.child("stock").addListenerForSingleValueEvent(new ValueEventListener() {
                        ...
                        public void onCancelled(@NonNull DatabaseError databaseError) {
                            Toast.makeText(WheatActivity.this,"Unable to Connect to database ",
                                    Toast.LENGTH_SHORT).show();
                        }
                    });
                    Log.i(" Quantity Success","Quantity Success");
                    Toast.makeText(WheatActivity.this, "Quantity Updated Success", Toast.LENGTH_SHORT).show();
                }
            }
        });
...
//                Log.d(TAG, "onChildMoved:" + dataSnapshot.getKey());
            ...
            public void onCancelled(@NonNull DatabaseError databaseError) {
                ...
                Toast.makeText(WheatActivity.this, "Failed to load User data.",Toast.LENGTH_SHORT).show();
